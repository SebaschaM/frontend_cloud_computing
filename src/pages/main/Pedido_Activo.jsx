      ...
      <div className="content_main_pedido_logeado">
        <div className="content_login_pedido_logeado">
          <div className="content_text logeado">
            <p className="title_pedcido_logeado">Pedidos</p>
          ...
          <div className="content_buton_Pedido">
            <button className="btn_Activo btnSelect">Activos</button>
            <button className="btn_Completado btnNoselect">Completados</button>
          </div>
        </div>
